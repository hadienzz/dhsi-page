          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="lg:col-span-1">
              <Card className="overflow-hidden shadow-xl">
                <div className="h-40 bg-gradient-to-br from-slate-600 to-slate-800 flex items-center justify-center">
                      ...
                      <AccordionTrigger className="hover:no-underline">
                        <div className="flex items-center gap-3 text-left">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-500">
                              {module.learningObjectives.length} tujuan pembelajaran
                            </p>
                          </div>
                        </div>
                      </AccordionTrigger>
              ...
              <CardContent>
                <dl className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <dd className="font-medium text-slate-900">{course.category}</dd>
                  </div>
                  <div className="flex justify-between">
